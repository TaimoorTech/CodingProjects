class Phonebook(list):
    ...
    def additems(self, n, pn, e):
        ...
        self.Email = e
        self.append([self.Name, self.PhoneNumbers, self.Email])
...
class ProtectedPhoneBook(Phonebook):  # Inheriting the Phonebook class
    def __init__(self):
        super().__init__()

    def pop(self, pos=-1):
        print("This does not allow any deletion from the Records. You can not use pop().")

    def remove(self, element):
        print("This does not allow any deletion from the Records. You can not use remove().")
