...
public class books extends AppCompatActivity {
    ...
    String books_title[] = {"Harry Potter and the Philosopher's Stone",
            ...
            "RED Planet", "SEEDS of HATRED", "The Girl on the Train"};
    int book_images[] = {R.drawable.harry1, R.drawable.harry2, R.drawable.harry3,
            ...
            R.drawable.dreamingarts, R.drawable.heartspringbook, R.drawable.redplanet,
            R.drawable.seedshatred, R.drawable.train};
    double rating[] = {4.5, 4, 3.5, 3, 4.5, 5, 4, 4, 5, 4.5, 4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findinglocation5 = findViewById(R.id.loc5);
        list_page_cart = findViewById(R.id.cart2);
        display_names = findViewById(R.id.display_name);
        recyclerView = findViewById(R.id.recyclerView1);

        findinglocation5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(books.this, MapsActivity.class);
                startActivity(i);
            }
        });
