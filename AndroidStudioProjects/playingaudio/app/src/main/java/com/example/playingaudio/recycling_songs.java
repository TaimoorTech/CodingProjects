...
public class recycling_songs extends RecyclerView.Adapter<recycling_songs.MyViewHolder> {
    ...
    public recycling_songs(Context c, String[] m_song, ArrayList<File> main_arraylist, String[] song, ArrayList<File> change_arraylist, String[] t){
    ...
    public void filter(Context c, String[] filtered_song, ArrayList<File> filtered_arraylist, String[] time){
        context = c;
        songs = filtered_song;
